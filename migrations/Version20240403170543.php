 ...
 */
final class Version20240403170543 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE notifications (id INT AUTO_INCREMENT NOT NULL, users_id INT DEFAULT NULL, subject VARCHAR(255) NOT NULL, short_text VARCHAR(255) NOT NULL, long_message VARCHAR(255) NOT NULL, INDEX IDX_6000B0D367B3B43D (users_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
